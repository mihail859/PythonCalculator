...
label = Label(window, textvariable=equation_label, borderwidth=5, font=('consolas', 20), bg="white", width=24, height=2)
label.pack()

frame = Frame(window)
frame.pack()
# frame, text=1, height=4, width=9, font=35,
...
clear_button = Button(window, text="Clear", height=4, width=18, font=35,
                      command=clear)
clear_button.pack()
